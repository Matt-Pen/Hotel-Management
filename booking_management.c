...
void displayBookingsMenu(void)
{
    ...
    printf("2. Check-Out Bookings\n");
    printf("3. Check-In Bookings\n");
    printf("4. Bookings by Guest\n");
    printf("5. Bookings by Room\n");
    printf("6. Back\n");
    ...
    case 3:
        ...
        break;
    case 4:
        displayBookingsByGuest();
        break;
    case 5:
        displayBookingsByRoom();
        break;
    case 6:
        return;
    }
...
void displayBookingsByGuest(void)
{
    ...
    if (!found)
        printf("No bookings found for Guest %d.\n", guestId);
}
...
void displayBookingsByRoom(void)
{
    ...
    if (!found)
        printf("No bookings found for Room %d.\n", roomId);
}
